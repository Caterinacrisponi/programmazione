...
vol1 = osc1group(vslider("[02] vol1 [unit:db]", 0,-96,0,1) : ba.db2linear : si.smoo) ;
vol2 = osc2group(vslider("[02] vol2 [unit:db]", 0,-96,0,1) : ba.db2linear : si.smoo) ;
vol3 = osc3group(vslider("[02] vol3 [unit:db]", 0,-96,0,1) : ba.db2linear : si.smoo) ;
vol4 = osc4group(vslider("[02] vol4 [unit:db]", 0,-96,0,1) : ba.db2linear : si.smoo) ;
